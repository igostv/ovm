...
Процедура ВыполнитьМиграцию() Экспорт
	...
	Если ЭтоWindows Тогда
		...
		НоваяПеременнаяPATH = "%OVM_OSCRIPTBIN%;" + ПеременнаяPATH;
		УстановитьПеременнуюСредыВРеестре("PATH", "REG_EXPAND_SZ", НоваяПеременнаяPATH,
			РасположениеПеременнойСреды.Машина);
		УстановитьПеременнуюСредыСОповещением("OVM_OSCRIPTBIN", ПутьКBinСистемногоOscript,
			РасположениеПеременнойСреды.Машина);
...
Процедура УстановитьПеременнуюСредыВРеестре(
	...
	Знач УровеньПеременнойСреды
)

	Если УровеньПеременнойСреды = РасположениеПеременнойСреды.Машина Тогда
...
Процедура УстановитьПеременнуюСредыСОповещением(
	...
	Если Расположение = РасположениеПеременнойСреды.Машина Тогда
